          ...
          children: <Widget>[
                  ...
                  onChanged: (val) {
                    setState(() {
                      if (selectedBible[0] == true &&
                          selectedBible[1] == false &&
                          selectedBible[2] == false) {
                        toast("최소 하나 이상의 역본을 선택해야 합니다.");
                      } else {
                        Provider.of<AppStateNotifier>(context, listen: false)
                            .setSelectedBibleState(0);
            ...
            ListTile(
                ...
                leading: Checkbox(
                  ...
                  onChanged: (val) {
                    setState(() {
                      if (selectedBible[0] == false &&
                          selectedBible[1] == true &&
                          selectedBible[2] == false) {
                        toast("최소 하나 이상의 역본을 선택해야 합니다.");
                      } else {
                        Provider.of<AppStateNotifier>(context, listen: false)
                            .setSelectedBibleState(1);
                ...
                leading: Checkbox(
                  ...
                  onChanged: (val) {
                    setState(() {
                      if (selectedBible[0] == false &&
                          selectedBible[1] == false &&
                          selectedBible[2] == true) {
                        toast("최소 하나 이상의 역본을 선택해야 합니다.");
                      } else {
                        Provider.of<AppStateNotifier>(context, listen: false)
                            .setSelectedBibleState(2);
